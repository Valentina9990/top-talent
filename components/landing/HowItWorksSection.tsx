...
const STEPS = [
  {
    ...
    description: "Crea tu cuenta como jugador o escuela en menos de 2 minutos.",
    icon: (
  ...
  },
  {
    ...
    description: "Agrega tu información, videos, estadísticas o datos de tu escuela.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Descubre oportunidades, recibe ofertas y lleva tu carrera deportiva al siguiente nivel.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="container mx-auto px-4">
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Ya seas jugador o escuela, el proceso es rápido y sencillo.
          </p>
        </div>
