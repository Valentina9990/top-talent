  ...
  return (
    <div className="mt-6 flex flex-wrap gap-4">
      <div className="text-center p-4 bg-gray-50 rounded-lg flex-1 min-w-[100px]">
        <p className="text-3xl font-bold text-primary-600">{goals || 0}</p>
        <p className="text-sm text-gray-500">Goles</p>
      </div>
      <div className="text-center p-4 bg-gray-50 rounded-lg flex-1 min-w-[100px]">
        <p className="text-3xl font-bold text-primary-600">{assists || 0}</p>
        <p className="text-sm text-gray-500">Asistencias</p>
      </div>
      <div className="text-center p-4 bg-gray-50 rounded-lg flex-1 min-w-[100px]">
        <p className="text-3xl font-bold text-primary-600">{matchesPlayed || 0}</p>
